...
async function defaultAction(projectPaths: string, options: CleanerOptions): Promise<void> {
    for (const projectPathRaw of projectPaths) {
        try {
...
program
    .argument('<project-paths...>', 'File path to project files that need to be cleaned')
